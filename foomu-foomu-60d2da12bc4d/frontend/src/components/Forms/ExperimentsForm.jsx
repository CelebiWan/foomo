...
function FormulaForm() {
  ...
  const { isOpen: isRecipesModalOpen, onOpen: onRecipesModalOpen, onClose: onRecipesModalClose } = useDisclosure();
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <FormControl id="recipe">
          ...
          <Button onClick={onRecipesModalOpen}>+</Button>
        </FormControl>

        <Modal isOpen={isRecipesModalOpen} onClose={onRecipesModalClose}>
          <ModalOverlay />
          <ModalContent>
