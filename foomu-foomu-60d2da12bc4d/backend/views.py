...
from .serializers import (
    ...
    IngredientPropertySerializer,
    InteractionTypeSerializer,
    InteractionSerializer,
    FunctionalitySerializer,
    RecipeSerializer,
    RecipeMetadataSerializer,
    FormulaSerializer,
    FormulaPropertySerializer,
    FormulaMetadataSerializer,
    FormulaTypeSerializer,
    ...
    ExperimentMethodSerializer,
    ExperimentValidationSerializer,
)
...
class IngredientPropertyViewSet(viewsets.ModelViewSet):
    queryset = IngredientProperty.objects.all()
...
class RecipeMetadataViewSet(viewsets.ModelViewSet):
    queryset = RecipeMetadata.objects.all()
...
class FormulaPropertyViewSet(viewsets.ModelViewSet):
    queryset = FormulaProperty.objects.all()
    serializer_class = FormulaPropertySerializer
    def create(self, request, *args, **kwargs):
        serializer = self.get_serializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        self.perform_create(serializer)
...
class FormulaMetadataViewSet(viewsets.ModelViewSet):
    queryset = FormulaMetadata.objects.all()
    serializer_class = FormulaMetadataSerializer
    def create(self, request, *args, **kwargs):
        serializer = self.get_serializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        self.perform_create(serializer)
...
class FormulaTypeViewSet(viewsets.ModelViewSet):
...
class QualitativeTypeViewSet(viewsets.ModelViewSet):
    queryset = QualitativeType.objects.all()
    serializer_class = QualitativeTypeSerializer
    def create(self, request, *args, **kwargs):
        serializer = self.get_serializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        self.perform_create(serializer)
...
class QualitativeResultViewSet(viewsets.ModelViewSet):
    queryset = QualitativeResult.objects.all()
    serializer_class = QualitativeResultSerializer
    def create(self, request, *args, **kwargs):
        serializer = self.get_serializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        self.perform_create(serializer)
...
class QuantitativeResultViewSet(viewsets.ModelViewSet):
    queryset = QuantitativeResult.objects.all()
    serializer_class = QuantitativeResultSerializer
    def create(self, request, *args, **kwargs):
        serializer = self.get_serializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        self.perform_create(serializer)
...
class ExperimentMethodViewSet(viewsets.ModelViewSet):
    queryset = ExperimentMethod.objects.all()
    serializer_class = ExperimentMethodSerializer
    def create(self, request, *args, **kwargs):
        serializer = self.get_serializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        self.perform_create(serializer)
...
class ExperimentValidationViewSet(viewsets.ModelViewSet):
    queryset = ExperimentValidation.objects.all()
    serializer_class = ExperimentValidationSerializer
    def create(self, request, *args, **kwargs):
        serializer = self.get_serializer(data=request.data)
        serializer.is_valid(raise_exception=True)
        self.perform_create(serializer)
